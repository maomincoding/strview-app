...
// 改变状态
Strview.prototype.useState = function () {
    console.log(this);
...
// 更新视图
Strview.prototype.setTemplate = function () {
...
// 判断文本节点
Strview.prototype.isTextNode = function (node) {
    return node.nodeType === 3;
}

// 编译DOM
Strview.prototype.compile = function (node, type) {
    if (type === 'o') {
...
// 字符串转DOM
Strview.prototype.toHtml = function (domStr) {
    const parser = new DOMParser();
    return parser.parseFromString(domStr, "text/html");
}

// 模板引擎
Strview.prototype.render = function (template) {
    const reg = /\{(\w+)\}/;
    if (template) {
